...
| 2026-08-21 | Completed | JMH smoke/full matrix and documentation synchronization completed; Closure proposal prepared | Java 21 JMH PASS; `mvn verify` PASS; exact-SHA CI `32459760130` PASS |
