...
The Human Developer conditionally approved ADR-0011 on `2026-08-20`: D1, D2
and D4-D7 are approved; D3 blocks implementation until ADR-0005 explicitly
separates input `Sequence` from output `EventSequence` semantics.
...
- [x] Record the conditional D1-D7 architecture decision.
- [x] Propose the explicit ADR-0005 sequence revision required by D3.
