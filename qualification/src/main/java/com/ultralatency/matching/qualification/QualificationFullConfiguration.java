 ...
 * @param minimumPostGcSamples minimum natural post-GC samples for the heap guard
...
public record QualificationFullConfiguration(
    ...
    /** Minimum natural samples required by ADR-0017 D7. */
    public static final int FULL_MINIMUM_POST_GC_SAMPLES = 5;
    ...
    public QualificationFullConfiguration {
        ...
        if (lane == QualificationLane.FULL
            ...
            throw new IllegalArgumentException(
                    "FULL lane requires 60 minutes, 1,000,000 commands and five post-GC samples");
        }
    }
