...
| Latest product task | [`TASK-20260825-048`](../tasks/active/TASK-20260825-048-phase11-reproducibility-security-preflight.md) — In Progress; Human-approved B2/B3 remediation; replacement execution not authorized |
...
| Current planning task | TASK-20260825-048 — In Progress; G9 publication contract remediation and G11 repository-secret provisioning pending; old failures preserved; no third run |
...
ADR-0011 Final Approved
  ...
  -> TASK-048 [In Progress; Human-approved B2/B3 remediation: pinned artifact publication plus repository-level `NVD_API_KEY`; replacement G9 `32847427690` and G11 `32847442506` remain preserved non-qualifying evidence; no third run]
