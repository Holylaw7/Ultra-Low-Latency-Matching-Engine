...
| Latest product task | [`TASK-20260825-048`](../tasks/active/TASK-20260825-048-phase11-reproducibility-security-preflight.md) — In Progress; B2/B3 remediation Evidence Gate PASS; replacement execution separately Human-gated |
...
| Current planning task | TASK-20260825-048 — In Progress; G9/G11 replacement execution not authorized |
...
ADR-0011 Final Approved
  ...
  -> TASK-048 [In Progress; B2/B3 remediation Evidence Gate PASS; implementation `b44fc4d`; final docs/status `c01977a`; Standard CI `32845529323` / Quick `32845529342` PASS; G9 `32842119210` and G11 `32842122498` remain preserved FAIL/non-qualifying; replacement execution not authorized]
