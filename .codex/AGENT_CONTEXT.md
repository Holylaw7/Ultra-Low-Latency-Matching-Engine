...
| Latest product task | [`TASK-20260825-048`](../tasks/active/TASK-20260825-048-phase11-reproducibility-security-preflight.md) — In Progress; replacement runs complete; final G9/G11 evidence review CHANGES REQUIRED |
...
| Current planning task | TASK-20260825-048 — In Progress; G9 `32847427690` artifact evidence incomplete, G11 `32847442506` FAIL/B3; no third run |
...
ADR-0011 Final Approved
  ...
  -> TASK-048 [In Progress; B2/B3 remediation PASS; replacement G9 `32847427690` technical PASS but no persisted artifacts, G11 `32847442506` FAIL/B3 due absent NVD secret; prior failures preserved; no third run]
